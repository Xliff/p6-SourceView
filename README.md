...
Switch to that directory and clone both p6-GtkPlus and p6-SourceView

```
$ git clone https://github.com/Xliff/p6-Pango.git
$ git clone https://github.com/Xliff/p6-GtkPlus.git
$ git clone https://github.com/Xliff/p6-SourceView.git
$ cd p6-GtkPlus
$ zef install --deps-only .
```

[Optional] To build all of SourceView and the required GTK modules, you can change to the p6-SourceView directory and do:
